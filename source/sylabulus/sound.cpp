...
static SoundDesc soundInfo[512]={
	...
	{/*SND_REVERSE,*/ "Double!",ST_INTFACE|ST_VOCAL|ST_PLAYER},
	{/*SND_REFLECT,*/ "Off the Walls!",ST_INTFACE|ST_VOCAL|ST_PLAYER},
...
static SoundDesc soundInfo2[512] = { // starts from index 512, doing this for now until i can redefine custom sound indexes
	...
	{/*SND_YERFSUCK,*/ "Yerfdog Suck",ST_MONSTER},
	{/*SND_YERFSPEW,*/ "Yerfdog Spew",ST_MONSTER},
	{/*SND_YERFCAUGHT,*/ "Yerfdog Caught",ST_MONSTER},
	{/*SND_YERFOUCH,*/ "Yerfdog Ouch",ST_MONSTER|ST_VOCAL},
	{/*SND_YERFDIE,*/ "Yerfdog Defeated",ST_MONSTER|ST_VOCAL},
	{/*SND_LANTERNSPIT,*/ "Lantern Spit",ST_MONSTER},
	{/*SND_LANTERNDIE,*/ "Lantern Die",ST_MONSTER},
	{/*SND_HARDHATTAUNT,*/ "Hardhat Taunt",ST_MONSTER|ST_VOCAL},
	{/*SND_HARDHATSHOOT,*/ "Hardhat Shoot",ST_MONSTER},
	{/*SND_HARDHATOUCH,*/ "Hardhat Ouch",ST_MONSTER},
	{/*SND_HARDHATDIE,*/ "Hardhat Die",ST_MONSTER},
	{/*SND_,*/ "Pelican Spew",ST_MONSTER},
	{/*SND_,*/ "Pelican Ouch",ST_MONSTER},
	{/*SND_,*/ "Pelican Die",ST_MONSTER},
	{/*SND_,*/ "Ninja Taunt",ST_MONSTER},
	{/*SND_,*/ "Ninja Sword",ST_MONSTER},
	{/*SND_,*/ "Ninja Ouch",ST_MONSTER},
	{/*SND_,*/ "Ninja Die",ST_MONSTER},
	{/*SND_,*/ "Jimbo Awaken",ST_MONSTER},
	{/*SND_,*/ "Jimbo Attack",ST_MONSTER},
	{/*SND_,*/ "Jimbo Ouch",ST_MONSTER},
	{/*SND_,*/ "Jimbo Die",ST_MONSTER},
	{/*SND_,*/ "Mikasa Taunt",ST_MONSTER},
	{/*SND_,*/ "Mikasa Attack",ST_MONSTER},
	{/*SND_,*/ "Mikasa Ouch",ST_MONSTER},
	{/*SND_,*/ "Mikasa Die",ST_MONSTER},
	{/*SND_,*/ "NohMann:Cmdy Atk1",ST_MONSTER},
	{/*SND_,*/ "NohMann:Cmdy Atk2",ST_MONSTER},
	{/*SND_,*/ "NohMann:Cmdy Ouch",ST_MONSTER},
	{/*SND_,*/ "NohMann:Trgdy Atk1",ST_MONSTER},
	{/*SND_,*/ "NohMann:Trgdy Atk2",ST_MONSTER},
	{/*SND_,*/ "NohMann:Trgdy Ouch",ST_MONSTER},
	{/*SND_,*/ "Noh-Mann:Switch",ST_MONSTER},
	{/*SND_,*/ "Noh-Mann:Die",ST_MONSTER},
	{/*SND_,*/ "Eyeball Tree Ouch",ST_MONSTER},
	{/*SND_,*/ "Eyeball Tree Die",ST_MONSTER},
	{/*SND_,*/ "H.S.Ninja Flex",ST_MONSTER},
	{/*SND_,*/ "H.S.Ninja Attack",ST_MONSTER},
	{/*SND_,*/ "H.S.Ninja Ouch",ST_MONSTER},
	{/*SND_,*/ "H.S.Ninja Die",ST_MONSTER},
	{/*SND_,*/ "Crazy Bush Ouch",ST_MONSTER},
	{/*SND_,*/ "Crazy Bush Die",ST_MONSTER},
	{/*SND_,*/ "Bombie: Bombs Away",ST_MONSTER|ST_VOCAL},
	{/*SND_,*/ "Glue Attack",ST_EFFECT},
	{/*SND_,*/ "Richie Lich Ouch",ST_MONSTER},
	{/*SND_,*/ "Richie Lich Die",ST_MONSTER},
	{/*SND_,*/ "Spikeball Clank",ST_MONSTER|ST_EFFECT},
	{/*SND_,*/ "Spikeball Bounce",ST_MONSTER|ST_EFFECT},
	{/*SND_,*/ "Combo:Unstoppable",ST_PLAYER|ST_VOCAL|ST_EFFECT},
	{/*SND_,*/ "Combo",ST_VOCAL|ST_PLAYER|ST_EFFECT},
	{/*SND_,*/ "Secret Area",ST_VOCAL|ST_EFFECT},
	{/*SND_,*/ "Combo:Toasty!",ST_VOCAL|ST_EFFECT},
	{/*SND_,*/ "Sphinxter Ouch",ST_MONSTER},
	{/*SND_,*/ "Sphinxter Die",ST_MONSTER},
	{/*SND_,*/ "Gong!!",ST_EFFECT},
	{/*SND_,*/ "BIG Brain Get",ST_EFFECT},
	{/*SND_,*/ "BIG Candle Get",ST_EFFECT},
	{/*SND_,*/ "BIG Coin Get",ST_EFFECT},
	{/*SND_,*/ "Turret Deploy",ST_EFFECT},
};
