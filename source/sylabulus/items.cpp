...
static const item_t baseItems[] = {
	...
	// rarity, flags, themes, trigger,
	// effect, effect amt, msg, sound

	// Basic items
	{"Hammer Up!",0,0,0,0,0,0, // animated
		0,IF_PICKUP,ITH_COLLECTIBLE|ITH_POWERUP,ITR_GET,
		IE_HAMMER,1,"Hammer Up!",SND_HAMMERUP},
	{"Pants Of Power",0,0,1,0,0,0, // animated
		0,IF_PICKUP,ITH_COLLECTIBLE|ITH_POWERUP,ITR_GET,
		IE_PANTS,1,"Pants Of Power!",SND_PANTS},
	{"Brain",0,0,2,0,0,0, // animated
		0,IF_PICKUP,ITH_COLLECTIBLE,ITR_GET,
		IE_BRAIN,1,"",SND_GETBRAIN},
	{"Candle",0,0,3,0,0,0, // animated
		0,IF_PICKUP,ITH_COLLECTIBLE,ITR_GET,
		IE_CANDLE,1,"",SND_CANDLEGET},
	{"Coin",0,0,4,0,0,0, // TODO: animate.
		100,IF_PICKUP,ITH_COLLECTIBLE,ITR_GET,
		IE_COIN,1,"",SND_COINGET},

	{"Reverse Hammer",0,0,5,4,3,2, // animated
		0,IF_PICKUP,ITH_POWERUP,ITR_GET,
		IE_POWERUP,PU_REVERSE,"Reverse Hammer!",SND_REVERSE},
	{"Sproingy Spring",0,0,6,0,0,0, // animated
		0,IF_PICKUP,ITH_POWERUP,ITR_GET,
		IE_POWERUP,PU_REFLECT,"Sproingy Spring!",SND_REFLECT},
	{"Hammer Down.",0,0,0,4,0,-2, // animated
		0,IF_PICKUP,ITH_POWERUP,ITR_GET,
		IE_HAMMER,-1,"Hammer Down...",SND_HAMMERDN},
	{"Pants of Futility",0,0,1,3,0,0, // animated
		0,IF_PICKUP,ITH_POWERUP,ITR_GET,
	...
	{"Lunchbox",0,0,20,0,0,0, // TODO: make sprite
		0,IF_PICKUP,ITH_WEAPON,ITR_GET,
	...
	{"Reflection Shield",0,0,24,0,0,0, // TODO: make sprite
		0,IF_PICKUP,ITH_WEAPON,ITR_GET,
		IE_WEAPON,WPN_REFLECTOR,"Reflection Shield!",SND_WEAPON},
	{"Jetpack",0,0,25,0,0,0,
		0,IF_PICKUP,ITH_WEAPON,ITR_GET,
		IE_WEAPON,WPN_JETPACK,"Jetpack!",SND_WEAPON},
	{"Swapgun",0,0,26,0,0,0, // TODO: make sprite
		0,IF_PICKUP,ITH_WEAPON,ITR_GET,
		IE_WEAPON,WPN_SWAPGUN,"Swapgun!",SND_WEAPON},
	{"Scanner",0,0,27,0,0,0, // TODO: make sprite
		0,IF_PICKUP,ITH_WEAPON,ITR_GET,
		IE_WEAPON,WPN_SCANNER,"Scanner!",SND_WEAPON},
	{"Stopwatch",0,0,28,0,0,0, // TODO: make sprite  (PRIORITY!)
		0,IF_PICKUP,ITH_WEAPON,ITR_GET,
		IE_WEAPON,WPN_STOPWATCH,"Stopwatch!",SND_WEAPON},
	{"R.G. Blaster",0,0,29,0,0,0, // TODO: make sprite  (PRIORITY!)
		0,IF_PICKUP,ITH_WEAPON,ITR_GET,
		IE_WEAPON,WPN_RAINBOWGUN,"R.G. Blaster!",SND_WEAPON},
	{"Abyssinator",0,0,30,0,0,0, // TODO: make sprite
		0,IF_PICKUP,ITH_WEAPON,ITR_GET,
		IE_WEAPON,WPN_BLACKHOLE,"Abyssinator!",SND_WEAPON},
	{"Glue Gun",0,0,31,0,0,0, // TODO: make sprite
		0,IF_PICKUP,ITH_WEAPON,ITR_GET,
		IE_WEAPON,WPN_GLUEGUN,"Glue Gun!",SND_WEAPON},
	{"Bouapha's Favorite Gun",0,0,32,0,0,0, // TODO: make sprite
		0,IF_PICKUP,ITH_WEAPON,ITR_GET,
		IE_WEAPON,WPN_BFG,"B.F.G.!!!",SND_GONG},
	{"Throwing Stars",0,0,33,0,0,0, // TODO: make sprite (PRIORITY!)
		0,IF_PICKUP,ITH_WEAPON,ITR_GET,
		IE_WEAPON,WPN_BFG,"Throwing Stars!",SND_WEAPON},
	{"Molecular Destabilizer",0,0,34,0,0,0, // TODO: make sprite
		0,IF_PICKUP,ITH_WEAPON,ITR_GET,
		IE_WEAPON,WPN_DESTABILIZER,"Molecular Destabilizer!",SND_WEAPON},
	{"Decoy Kit",0,0,35,0,0,0, // TODO: make sprite  (PRIORITY!)
		0,IF_PICKUP,ITH_WEAPON,ITR_GET,
		IE_WEAPON,WPN_DESTABILIZER,"Decoy Kit!",SND_ROBOBOUAPHAON},

	// Mech weapons
	{"Power Armor",0,0,36,0,0,0, // TODO: make sprite
		0,IF_PICKUP,ITH_WEAPON|ITH_POWERUP,ITR_GET,
		IE_WEAPON,WPN_PWRARMOR,"Power Armor!",SND_ROBOBOUAPHAON},
	{"Mini-Sub",0,0,37,0,0,0, // TODO: make sprite
		0,IF_PICKUP,ITH_WEAPON|ITH_POWERUP,ITR_GET,
		IE_WEAPON,WPN_MINISUB,"Mini-Sub!",SND_ROBOBOUAPHAON},

	// Food + powerups
	{"Chinese Takeout",0,0,38,0,0,0, // TODO: make sprite
		0,IF_PICKUP,ITH_COLLECTIBLE|ITH_POWERUP,ITR_GET,
		IE_HEALRANDOM,0,"",SND_FOOD},
	{"Energy Shield",0,0,39,0,0,0, // TODO: make (better) sprite
		0,IF_PICKUP,ITH_POWERUP,ITR_GET,
		IE_POWERUP,PU_SHIELD,"",SND_SHIELD},
	{"Radioactive Chinese",0,0,40,0,0,0, // TODO: make (better) sprite
		0,IF_PICKUP,ITH_POWERUP,ITR_GET,
		IE_WEIRD,0,"",SND_FOOD}, // maybe make this a new sound
	{"Pizza",0,0,41,0,0,0, // TODO: make sprite
		0,IF_PICKUP,ITH_POWERUP,ITR_GET,
	...
	{"Power Belt",0,0,45,0,0,0, // TODO: make sprite
		0,IF_PICKUP,ITH_POWERUP,ITR_GET,
		IE_POWERUP,PU_STRENGTH,"Power Belt!",SND_SPEEDUP},
	{"The Cloak Invisible",0,0,46,0,0,0, // TODO: make sprite
		0,IF_PICKUP|IF_GLOW,ITH_POWERUP,ITR_GET,
		IE_POWERUP,PU_INVISO,"The Cloak Invisible!",SND_SPEEDUP},
	{"Ammo:Small",0,0,47,0,0,0, // TODO: make sprite
		0,IF_PICKUP,ITH_POWERUP|ITH_COLLECTIBLE,ITR_GET,
		IE_POWERUP,PU_AMMO2,"Ammo Pack!",SND_WORLDTURN},
	{"Ammo:Medium",0,0,48,0,0,0, // TODO: make sprite
		0,IF_PICKUP,ITH_POWERUP|ITH_COLLECTIBLE,ITR_GET,
		IE_POWERUP,PU_AMMO2,"Ammo Pack!",SND_WORLDTURN}, // TODO: make ammo thingy
	{"Ammo Crate",0,0,49,0,0,0, // TODO: make sprite
		0,IF_PICKUP,ITH_POWERUP|ITH_COLLECTIBLE,ITR_GET,
		IE_POWERUP,PU_AMMO,"Ammo Crate!!",SND_AMMOCRATE},
	{"Scuba Gear",0,0,50,0,0,0, // TODO: make sprite
		0,IF_PICKUP,ITH_POWERUP|ITH_COLLECTIBLE,ITR_GET,
		IE_OXYGEN,128,"Scuba Gear!",SND_SCUBA},
	{"Supreme Squeezy Cheese",0,0,51,0,0,0, // TODO: make sprite
		0,IF_PICKUP,ITH_POWERUP,ITR_GET,
		IE_POWERUP,PU_CHEESE,"Supreme Squeezy Cheese!!",SND_GONG},
	{"Aqueous Boots",0,0,52,0,0,0, // TODO: make sprite
		0,IF_PICKUP,ITH_POWERUP,ITR_GET,
		IE_POWERUP,PU_WATRWALK,"Aqueous Boots!!",SND_GONG},
	{"Pocket",0,0,53,0,0,0, // TODO: animate it!
		0,IF_PICKUP,ITH_POWERUP,ITR_GET,
	...
	{"Keychain:Shroom",0,0,62,0,0,0, // TODO: make sprite, animate.
		0,IF_PICKUP,ITH_COLLECTIBLE,ITR_GET,
