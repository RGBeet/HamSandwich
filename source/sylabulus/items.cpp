...
static const item_t baseItems[] = {
	...
	{"Dead Tree 1",0,0,0,124,0,0,0,
		0,ITH_OBSTACLE|ITH_BULLETPROOF|ITH_PLANTS,ITA_SHADOW,ITP_BULLETPROOF,ITRG_NONE,ITB_NONE,0,
		IE_NONE,0,"",0},
	...
	{"Toadstool",0,0,0,131,0,0,0,
		0,ITH_OBSTACLE|ITH_PLANTS,ITA_SHADOW,ITP_SOLID,ITRG_NONE,ITB_NONE,0,
		IE_NONE,0,"",0},

	// Rocks
	{"Rocks:Large",0,0,0,132,0,0,0,
		0,ITH_OBSTACLE|ITH_ROCKS,ITA_SHADOW,ITP_SOLID,ITRG_NONE,ITB_NONE,0,
		IE_NONE,0,"",0},
	{"Rocks:Small",0,0,0,133,0,0,0,
		0,ITH_OBSTACLE|ITH_ROCKS,ITA_NONE,ITP_SOLID,ITRG_NONE,ITB_NONE,0,
		IE_NONE,0,"",0},
	{"Boulder:Tall",0,0,0,135,0,0,0,
		0,ITH_OBSTACLE|ITH_BULLETPROOF|ITH_ROCKS,ITA_SHADOW,ITP_BULLETPROOF,ITRG_NONE,ITB_NONE,0,
		IE_NONE,0,"",0},
	{"Boulder:Short",0,0,0,136,0,0,0,
		0,ITH_OBSTACLE|ITH_ROCKS,ITA_NONE,ITP_SOLID,ITRG_NONE,ITB_NONE,0,
		IE_NONE,0,"",0},
	{"Rocks:Huge",0,0,0,138,0,0,0,
		0,ITH_OBSTACLE|ITH_BULLETPROOF|ITH_ROCKS|ITH_LARGE,ITA_SHADOW,ITP_BULLETPROOF,ITRG_NONE,ITB_NONE,0,
		IE_NONE,0,"",0},
	...
	{"Target",0,0,0,155,0,0,0,
		0,ITH_OBSTACLE|ITH_BULLETPROOF,ITA_SHADOW,ITP_SOLID,ITRG_NONE,ITB_NONE,0,
		IE_NONE,0,"",0},
	...
	{"Mine Block",0,0,0,161,0,0,0,
		0,ITH_OBSTACLE|ITH_BULLETPROOF,ITA_SHADOW,ITP_BULLETPROOF,ITRG_MINECART,ITB_NONE,0,
		IE_DESTROY,2,"",0},
	...
	{"Hay Bale",0,0,0,163,0,0,0, // todo: have them burn
		0,ITH_OBSTACLE,ITA_NONE,ITP_SOLID,ITRG_FIRE,ITB_NONE,0,
		IE_DESTROY,5,"",0},
	{"Powder Keg",0,0,0,164,0,0,0,
		0,ITH_OBSTACLE|ITH_BULLETPROOF,ITA_SHADOW,ITP_BULLETPROOF,ITRG_FIRE,ITB_NONE,0,
		IE_EXPLODE,1,"",0},
	...
	{"Gong",0,0,0,169,0,0,0,
		0,ITH_OBSTACLE|ITH_BULLETPROOF|ITH_LARGE,ITA_SHADOW,ITP_BULLETPROOF,ITRG_NONE,ITB_NONE,0,
		IE_NONE,0,"",0},
...
byte TriggerItem(Guy *me,mapTile_t *m,int x,int y)
{
	...
	switch(items[m->item].effect)
	{
		...
		case IE_EXPLODE:
			ExplodeParticles(PART_SHRAPNEL, (x * TILE_WIDTH + TILE_WIDTH / 2) * FIXAMT, (y * TILE_HEIGHT + TILE_HEIGHT / 2) * FIXAMT, 0, 8);
			FireBullet((x * TILE_WIDTH + TILE_WIDTH / 2) * FIXAMT, (y * TILE_HEIGHT + TILE_HEIGHT / 2) * FIXAMT, 0, BLT_BOOM, 255);
			m->item = IT_NONE;
			return 1;
		...
		case IE_SCORE:
			if (player.score + items[m->item].effectAmt < 0 || player.score + items[m->item].effectAmt > 9999999)
				return 0; // cannot work with negative or too high score
			player.score += items[m->item].effectAmt;
			return 1;
	}
	return 0;
}
